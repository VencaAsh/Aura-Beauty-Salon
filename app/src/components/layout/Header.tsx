    ...
    <header className="bg-[#F5F3F0] p-5 sticky top-0 z-50 border-b border-[#E6CCB2]/10">
      <nav className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/blog" className="px-2 py-1 text-[#121212] hover:text-[#C9B8A8] transition-all duration-300 font-light text-xs tracking-widest relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#C9B8A8]/50 after:transition-all after:duration-300 hover:after:w-full">blog</Link>
          <Link href="/salon" className="px-2 py-1 text-[#121212] hover:text-[#C9B8A8] transition-all duration-300 font-light text-xs tracking-widest relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#C9B8A8]/50 after:transition-all after:duration-300 hover:after:w-full">salon</Link>
      ...
      >
        ...
        >
          <ul className="flex flex-col items-start p-8 space-y-6">
            ...
            <li className="w-full border-b border-[#E6CCB2]/10 pb-2"><Link href="/blog" className="text-[#121212] hover:text-[#C9B8A8] block font-light text-sm tracking-widest" onClick={() => setIsMenuOpen(false)}>blog</Link></li>
            <li className="w-full border-b border-[#E6CCB2]/10 pb-2"><Link href="/salon" className="text-[#121212] hover:text-[#C9B8A8] block font-light text-sm tracking-widest" onClick={() => setIsMenuOpen(false)}>salon</Link></li>
