      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16 max-w-3xl mx-auto">
          <div className="bg-white shadow-md border border-[#E6CCB2]/30 rounded-sm overflow-hidden hover:shadow-lg transition-all duration-300">
            <div className="p-8">
              <h3 className="text-xl font-serif font-light text-[#121212] mb-4 pb-3 border-b border-[#E6CCB2]/30">{BRANCHES[0].name}</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-5">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-[#121212] text-sm uppercase tracking-wider mb-1">Adresa</h4>
                      <p className="text-brand-secondary-dark font-light">{BRANCHES[0].address}</p>
                      <a
                        href={BRANCHES[0].mapUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-[#121212] hover:text-[#C9B8A8] text-sm inline-flex items-center mt-1 transition-colors duration-300"
                      >
                        Zobrazit na mapě
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-[#121212] text-sm uppercase tracking-wider mb-1">Telefon</h4>
                      <a
                        href={`tel:${BRANCHES[0].phone.replace(/\s/g, '')}`}
                        className="text-brand-secondary-dark hover:text-[#C9B8A8] transition-colors duration-300 font-light"
                      >
                        {BRANCHES[0].phone}
                      </a>
                    </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-[#121212] text-sm uppercase tracking-wider mb-1">E-mail</h4>
                      <a
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-[#121212] text-sm uppercase tracking-wider mb-1">Otevírací doba</h4>
