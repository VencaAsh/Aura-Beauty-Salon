...
const teamMember = {
  ...
  bio: 'Makrushyna je zakladatelkou a majitelkou Aura Beauty Salonu s více než 5 lety zkušeností v oblasti kosmetiky a wellness. Specializuje se na luxusní ošetření pleti, anti-aging procedury a holístický přístup ke kráse. Její vášeň pro dokonalost a individuální přístup ke každému klientovi z ní dělá vyhledávanou odbornici v oboru.',
  image: '/images/team/makrushyna.jpeg',
  phone: '+420 773 054 563',
  email: 'info@aurabeauty.cz',
  branch: 'Vítkovická 3080/10, 702 00 Ostrava',
